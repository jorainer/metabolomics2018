...
```{r chromatogram, message = FALSE, fig.width = 7.5, fig.height = 4 , eval = FALSE}
chr <- chromatogram(data)
plot(chr) 
```
```{r chromatogram-plot, message = FALSE, fig.width = 7.5, fig.height = 3.5 , echo = FALSE}
chr <- chromatogram(data)
...
- Example: extracted ion chromatogram for Serine (m/z of [M+H]+ adduct 106.0455).
